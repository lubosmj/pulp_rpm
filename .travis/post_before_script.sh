...
then
  ...
  CREATE_SIGNING_SERVICE="from pulpcore.app.models.content import AsciiArmoredDetachedSigningService as SigningService; SigningService.objects.create(name='sign-metadata', script='/root/sign-metadata.sh')"
